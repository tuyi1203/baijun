...
(function($)
{
    ...
    '            		非常抱歉，数据加载失败' +
    '                </div>' +
    '               <div class="dialogErrBtn"><a class="btn1 btnsFs" onclick="$(this).closeDialog();" href="javascript:void(0)">关闭</a></div>';
            ...
            switch (self.options.type)
            {
                case 'anchor': //定位于屏幕某一位置的窗口
					...
					html = '<div class="_dialog" id="_dialog' + self.id + '">' +
						   ...
						   '    	<div class="prtCon">'+
						   '    		<i class="fonticon">' + iconFont +'</i><span class="_dialogContent prtTxt"></span><span class="clear"></span>' +
						   '    	</div>' +
						   '    </div>'
						   '</div>';
                    break;
                ...
                case 'confirm': //确认窗口
                    ...
                    '    <div class="dialogHead _dialogHeader"><span class="_title">系统消息</span><a href="javascript:void(0)" class="dialogClose _dialogClose" title="关闭">×</a></div> ' +
						...
						'					<a href="javascript:void(0)" class="btn1 btnsFs _dialogOk">确&nbsp;定</a>' +
						'					<a href="javascript:void(0)" class="btn3 btnsFs _dialogCancel">取&nbsp;消</a>' +
						'				</div>' +
						'</div>' +
						'			</td>' +
