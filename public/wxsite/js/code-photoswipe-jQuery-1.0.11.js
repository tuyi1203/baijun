...
(function(window, Util, FullSizeImageClass){
	...
	Code.PhotoSwipe.SliderItemClass = Code.PhotoSwipe.EventClass.extend({
		...
		init: function(parentEl){
		    ...
		    // zhangyu
		    //$(this.imageContainerEl).find('img').zoom();
...
(function(window, Util, SliderItemClass){
	...
	Code.PhotoSwipe.SliderClass = Code.PhotoSwipe.ElementClass.extend({
		...
		init: function(options, parentEl){
			...
			var zoomImgBtn = Util.DOM.createElement('a', { 'class':'zoomImgbtn mw-icon zoomImgbtnClose','href':'javascript:void(0);'}, '');
			...
			// TODO: 
			$(zoomImgBtn).zoom({curObjClass:'.'+Code.PhotoSwipe.ToolbarClass.CssClasses.zoomBtn});
			Util.DOM.hide(this.el);
			Util.DOM.appendChild(this.el, parentEl);
			//Util.DOM.appendChild(zoomImgBtn,parentEl);
			Util.DOM.after(parentEl,zoomImgBtn);
		...
		resetPosition: function(){
			...
			//TODO
			$(this.currentItem.el).addClass(Code.PhotoSwipe.ToolbarClass.CssClasses.zoomBtn).siblings().removeClass(Code.PhotoSwipe.ToolbarClass.CssClasses.zoomBtn);
...
(function(window, Util, CaptionClass, ToolbarClass){
	...
	Code.PhotoSwipe.CaptionToolbarClass = Code.PhotoSwipe.EventClass.extend({
		...
		hide: function(){
			...
			// 
			swipeflg = true;	
			$('.zoomImgbtn').hide().initZoomStatus();
		},
