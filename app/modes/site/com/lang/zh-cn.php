...
$lang->graduate       = '毕业于';
$lang->school         = '毕业院校';
$lang->production	  = '代表作品';
$lang->teamgroup      = '所属团队：';
$lang->classicase     = '经典案例';
$lang->case           = '设计案例';
$lang->prev           = '上一篇：';
$lang->next           = '下一篇：';
$lang->news           = '家装风水学';
...
$lang->ideal          = '设计理念';
$lang->resume         = '个人履历';
$lang->hotdesigner    = '人气设计师';
$lang->settype		  = '套餐类型：';
$lang->styletype      = '装修风格：';
$lang->roomtype       = '居室类型：';
$lang->surfacetype    = '装修面积：';
$lang->areatype       = '建筑面积：';
$lang->name           = '名称：';
$lang->housedesign    = '户型设计';

$lang->join  		  = '招贤纳士';
$lang->joint		  = '强强联手';
$lang->sign           = '学装修';
$lang->renovation     = '家装设计知识';
$lang->review         = '家装攻略';
$lang->shop           = '样板间展示';
$lang->evaluation     = '口碑评价';
$lang->team           = '设计团队';
$lang->more           = '更多';
$lang->intro          = '公司简介';
$lang->mien		      = '团队风采';
$lang->housesubmit    = '户型提交';


$lang->customname     = '客户姓名：';
$lang->xiaoqu		  = '所属小区：';
$lang->bookingdetail  = '预约详情：';
$lang->booking		  = '业主预约';
$lang->bookme		  = '预约';
$lang->booked		  = '已预约';
$lang->designteam     = '设计团队';
$lang->teambelong     = '所属团队:';
$lang->levelbelong    = '设计级别:';
$lang->house	      = '楼盘名称：';
$lang->dstyle	      = '设计风格：';
$lang->totalprice     = '总造价：';
$lang->money		  = '万元';
...
$lang->nodesigner     = '没有找到相应的设计师';
$lang->nocase		  = '没有找到相应的案例';
$lang->dolikethis     = '我要这样装';

$lang->samestyle	  = '同类风格';
$lang->sameroom		  = '同类户型';
$lang->samedesigner	  = '同设计师';


$lang->seo = new stdClass();
$lang->seo->tail1         = "重庆亿家美装饰工程有限公司";
$lang->seo->tail2         = "重庆装饰装修设计";
$lang->seo->tail3         = "重庆装修设计装饰设计公司";
$lang->seo->tail4         = "重庆装饰装修联系电话：023-86219666";

$lang->seo->caselist      = "设计案例";
$lang->seo->projectlist   = "工程案例";
$lang->seo->teamlist      = "设计团队";
$lang->seo->contactus     = "联系我们";
...
$lang->forbidden->require       = "您还没有添加%s，请先添加%s。";
$lang->forbidden->auth          = "您无权进行该操作，如需取得操作权限，请联系管理员。";
$lang->forbidden->locate        = "<strong id='countDown'>%s</strong>秒后转向%s。";
$lang->notice					= "为确保您的预约能准确生效，请务必按照您的真实情况填写以下信息";
...
$lang->translate->module = '模块';
$lang->translate->firstlevelmodule = '一级模块';
$lang->translate->modulemente = '一级模块管理';

/* The error messages. */
// $lang->error = new stdclass();
// $lang->error->lengthbet    = '<strong>%s</strong>长度应当不超过<strong>%s</strong>个字符，且不小于<strong>%s</strong>个字符。';
// $lang->error->maxlength    = '<strong>%s</strong>长度错误，应当小于<strong>%s</strong>个字符';
// $lang->error->minlength    = '<strong>%s</strong>长度错误，应当大于<strong>%s</strong>个字符';
// $lang->error->reg          = '<strong>%s</strong>不符合格式，应当为:<strong>%s</strong>。';
// $lang->error->alphalower   = '<strong>%s</strong>应当为小写字母';
...
$lang->error = new stdclass();
$lang->error->lengthbet    = '%s长度应当不超过%s个字符，且不小于%s个字符。';
$lang->error->maxlength    = '%s长度错误，应当小于%s个字符';
$lang->error->minlength    = '%s长度错误，应当大于%s个字符';
$lang->error->reg          = '%s不符合格式，应当为:%s。';
$lang->error->alphalower   = '%s应当为小写字母';
$lang->error->unique       = '%s已经有%s这条记录了。';
$lang->error->notempty     = '%s不能为空。';
$lang->error->equal        = '%s必须为%s。';
$lang->error->in           = '%s必须为%s。';
$lang->error->int          = array('%s应当是数字。', '%s最小值为%s',  '%s应当介于%s-%s之间。');
$lang->error->float        = '%s应当是数字，可以是小数。';
$lang->error->email        = '%s应当为合法的EMAIL。';
$lang->error->url          = '%s应当为合法的URL。';
$lang->error->date         = '%s应当为合法的日期。';
$lang->error->account      = '%s应当为字母和数字的组合，至少三位';
$lang->error->passwordsame = '两次密码应当相等。';
$lang->error->passwordrule = '密码应该符合规则，长度至少为六位。';
$lang->error->captcha      = '请输入正确的验证码。';
$lang->error->idcard       = '请输入正确的身份证号。';
$lang->error->nowritable   = '%s 可能不可写，请修改权限！';
$lang->error->unique       = '该%s已经被使用。';
$lang->error->createdir    = '自动创建目录%s失败，已有同名文件夹或无权限，请手动创建。';
$lang->error->renamedir    = '自动更名目录%s失败，或无权限，请手动更改。';
$lang->error->tel          = '%s应当是正确的电话号码';
$lang->error->email        = '%s应当是正确的邮件地址';
...
$lang->article->publicstatus = '审核状态';
$lang->article->public     = '审核';
$lang->article->comments   = '评论';
$lang->article->stick      = '置顶级别';
$lang->article->order      = '排序';
$lang->article->draft      = '草稿';
$lang->article->normal     = '正常';
...
$lang->single = new stdClass();
// $lang->page->admin  = '维护单页';
// $lang->page->list   = '单页列表';
$lang->single->create = '添加单页';
// $lang->page->edit   = '编辑单页';
...
$lang->file->friendlinkinfo  = '链接图片尺寸应该保持一致，最佳图片尺寸：1140px X 270px(宽 X 高)';
$lang->file->setinfo         = '套餐图片尺寸应该保持一致，最佳图片尺寸：1140px X 270px(宽 X 高)';
$lang->file->notimage        = '上传文件需为图片文件。';
$lang->file->requireimage    = '没有选择图片';
...
//messagebox 留言框
$lang->messagebox = new stdClass();
$lang->messagebox->common     = "给亿家美装饰工程有限公司留言";
$lang->messagebox->name       = "姓名";
$lang->messagebox->tel        = "联系电话";
$lang->messagebox->content    = "留言内容";
$lang->messagebox->submit     = "提交留言";

//在线咨询consult
$lang->consult = new stdClass();
$lang->consult->common         =  "在线咨询";
$lang->consult->cs1            =  "客服专员一";
$lang->consult->cs2            =  "客服专员二";
$lang->consult->cs3            =  "客服专员三";
$lang->consult->qq             =  "QQ在线咨询";
$lang->consult->weibo          =  "官方微博";
$lang->consult->scan           =  "扫一扫";
$lang->consult->follow         =  "关注官方微信";

//顶部banner
$lang->head = new stdClass();
$lang->head->common         = '重庆亿家美装饰工程有限公司';
$lang->head->tel            = '服务热线';
