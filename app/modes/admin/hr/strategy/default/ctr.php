<?php
class clsHrStrategyDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->strategy->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->strategy->successupdate;
        $this->output->locate  = U('hr/strategy');
    }
