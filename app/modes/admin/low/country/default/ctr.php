<?php
class clsLowCountryDefaultController extends clsAppController
...
// pr($this->input->sort);
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->country->successsort;
        }
        else {
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->country->failsort;
        }
    ...
    public function _delete() {
        ...
        if(!$model->mw_file->delete($this->input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->country->faildelete;
            return;
        }
