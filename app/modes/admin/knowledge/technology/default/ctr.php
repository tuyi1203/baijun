<?php
class clsKnowledgeTechnologyDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if(!$this->loadController('admin.system.file.default')
            ...
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->knowledge->failupdate;
            return;
        }

        $this->output->result  = 'success';
        $this->output->message = $this->lang->technology->successupdate;
        $this->output->locate  = U('knowledge/technology');
    }
