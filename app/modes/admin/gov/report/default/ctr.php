<?php
class clsGovReportDefaultController extends clsAppController
...
//         var_dump($this->cookie->lang);
    ...
    private function init() {
        ...
        if (isset($_SESSION['action_auth_list']['admin']['gov/report/default/publish']) and
                $_SESSION['action_auth_list']['admin']['gov/report/default/publish']['operauth'] == '1') {
