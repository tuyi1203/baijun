<?php
class clsWebsitearticleDefaultController extends clsAppController implements IAction_default , IAction_update{
...
// pr($_SESSION);exit;
    ...
    public function _update() {
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->article->successupdate;
            $this->output->locate  = U('website/article/default/default.html');
        }
        else {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->article->failupdate;
        }
    }
