<?php
class clsWebsiteMoreDefaultController extends clsAppController implements IAction_default , IAction_update{
...
// pr($_SESSION);exit;
    ...
    public function _update() {
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->more->successupdate;
            $this->output->locate  = U('website/more/default/default.html');
        }
        else {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->more->failupdate;
        }
    }
