<?php
class clsWebsiteserviceDefaultController extends clsAppController implements IAction_default , IAction_update{
...
// pr($_SESSION);exit;
    ...
    public function _update() {
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->service->successupdate;
            $this->output->locate  = U('website/service/default/default.html');
        }
        else {
            $this->output->result  = 'fail';
