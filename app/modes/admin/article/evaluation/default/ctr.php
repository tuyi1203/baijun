...
class clsArticleEvaluationDefaultController extends clsAppController {
...
//         var_dump($this->cookie->lang);
    ...
    public function _delete() {
        ...
        if(!$model->mw_article->delete($this->input)) {
            ...
            $this->output->message = $this->lang->evaluation->faildelete;
    ...
    public function _publish() {
        ...
        if(!$this->publish()) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->evaluation->failpublish;
            return;
        }
        $this->output->result  = 'success';
    }
