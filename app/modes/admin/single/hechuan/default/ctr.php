<?php
class clsSingleHechuanDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->hechuan->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->hechuan->successupdate;
        $this->output->locate  = U('single/hechuan/default/default.html');
