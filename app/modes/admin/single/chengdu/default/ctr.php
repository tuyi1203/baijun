<?php
class clsSingleChengduDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->chengdu->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->chengdu->successupdate;
        $this->output->locate  = U('single/chengdu/default/default.html');
