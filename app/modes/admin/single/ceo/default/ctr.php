<?php
class clsSingleCeoDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->ceo->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->ceo->successupdate;
        $this->output->locate  = U('single/ceo');
    }
