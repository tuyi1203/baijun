<?php
class clsSingleContactDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        $this->output->locate  = 'single_contact-default-default.html';
