<?php
class clsSingleChongqingDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->chongqing->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->chongqing->successupdate;
        $this->output->locate  = U('single/chongqing/default/default.html');
