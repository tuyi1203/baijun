<?php
class clsServiceMessageDefaultController extends clsAppController
...
//         var_dump($this->cookie->lang);
    ...
    public function _publish() {
        ...
        if(!$this->publish()) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->message->failpublish;
            return;
        }
        $this->output->result  = 'success';
    }
    ...
    private function init() {
        ...
        if (isset($_SESSION['action_auth_list']['admin']['service/message/default/publish']) and
                $_SESSION['action_auth_list']['admin']['service/message/default/publish']['operauth'] == '1') {
