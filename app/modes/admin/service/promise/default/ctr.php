<?php
class clsServicePromiseDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->promise->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->promise->successupdate;
        $this->output->locate  = U('service/promise');
    }
