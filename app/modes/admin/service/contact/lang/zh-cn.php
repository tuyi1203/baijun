...
$lang->contact->content2 = '联系电话';
$lang->contact->edit     = '联系我们编辑';
$lang->contact->picture  = '图片';
$lang->contact->link     = '链接';
$lang->contact->buttom   = '底部信息';
$lang->contact->contact  = '健康咨询电话';
$lang->contact->author   = '作者';
$lang->contact->picture  = '封面';
$lang->contact->showpic  = '封面图片显示在正文中';
$lang->contact->visiting = '门诊时间';
$lang->contact->label    = '按钮文字';
$lang->contact->desc     = '描述';
$lang->contact->createby = '创建人';
// $lang->slide->image    = '图片';
// $lang->slide->url      = '链接';
...
$lang->contact->successinsert   = '新增联系我们成功';
$lang->contact->failinsert      = '新增联系我们失败';
$lang->contact->successdelete   = '删除联系我们成功';
$lang->contact->faildelete      = '删除联系我们失败';
