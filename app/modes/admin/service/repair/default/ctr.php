<?php
class clsServiceRepairDefaultController extends clsAppController
...
//         var_dump($this->cookie->lang);
    ...
    public function _delete() {
        ...
        if(!$model->mw_message->delete($this->input)) {
            ...
            $this->output->repair = $this->lang->repair->faildelete;
            return;
        }
    ...
    public function _publish() {
        ...
        if(!$this->publish()) {
            $this->output->result  = 'fail';
            $this->output->repair = $this->lang->repair->failpublish;
            return;
        }
        $this->output->result  = 'success';
    }
    ...
    private function init() {
        ...
        if (isset($_SESSION['action_auth_list']['admin']['service/repair/default/publish']) and
                $_SESSION['action_auth_list']['admin']['service/repair/default/publish']['operauth'] == '1') {
