<?php
class clsCustomerClaimDefaultController extends clsAppController
...
//         var_dump($this->cookie->lang);
    ...
    public function _delete() {
        ...
        if(!$model->mw_message->delete($this->input)) {
            ...
            $this->output->claim = $this->lang->message->faildelete;
            return;
        }
    ...
    public function _publish() {
        ...
        if(!$this->publish()) {
            $this->output->result  = 'fail';
            $this->output->claim = $this->lang->message->failpublish;
            return;
        }
        $this->output->result  = 'success';
    }
    ...
    private function init() {
        ...
        if (isset($_SESSION['action_auth_list']['admin']['customer/claim/default/publish']) and
                $_SESSION['action_auth_list']['admin']['customer/claim/default/publish']['operauth'] == '1') {
