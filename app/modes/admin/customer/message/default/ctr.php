<?php
class clsCustomerMessageDefaultController extends clsAppController
...
//         var_dump($this->cookie->lang);
    ...
    private function init() {
        ...
        if (isset($_SESSION['action_auth_list']['admin']['customer/message/default/publish']) and
                $_SESSION['action_auth_list']['admin']['customer/message/default/publish']['operauth'] == '1') {
