...
$lang->album->common  = '事务所文化相册设置';
$lang->album->sort    = '排序';

$lang->album->edit    = '事务所文化相册编辑';
$lang->album->add     = '添加事务所文化相册';
$lang->album->title   = '事务所文化相册名';
$lang->album->desc    = '描述';
...
$lang->album->create     = '添加事务所文化相册';
$lang->album->albumtype  = '相册类别';
// $lang->slide->edit     = '编辑幻灯片';

$lang->album->successupdate   = '更新事务所文化相册成功';
$lang->album->failupdate      = '更新事务所文化相册失败';
$lang->album->successinsert   = '新增事务所文化相册成功';
$lang->album->failinsert      = '新增事务所文化相册失败';
$lang->album->successdelete   = '删除事务所文化相册成功';
$lang->album->faildelete      = '删除事务所文化相册失败';
