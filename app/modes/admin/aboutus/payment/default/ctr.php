<?php
class clsServicePaymentDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->payment->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->payment->successupdate;
        $this->output->locate  = U('service/payment');
    }
