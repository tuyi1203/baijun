<?php
class clsAboutusDutyDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->duty->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->duty->successupdate;
        $this->output->locate  = U('aboutus/duty');
    }
