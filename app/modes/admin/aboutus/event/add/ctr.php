<?php
class clsAboutusEventAddController extends clsAppController implements IAction_default , IAction_insert{
...
//              ->updateObjectID($this->input->uid, $insertid, 'event')) {
//             $this->output->result  = 'fail';
//             $this->output->message = $this->lang->event->failinsert;
//             return;
//         }
        ...
        $this->output->locate  = U('aboutus/event/default/default.html');
