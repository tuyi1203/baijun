<?php
class clsAboutusEventEditController extends clsAppController implements IAction_default , IAction_update {
...
//                  ->updateObjectID($this->input->uid, $this->input->id, 'event')) {
//             $this->output->result  = 'fail';
