<?php
class clsAboutusVisionDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->vision->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->vision->successupdate;
        $this->output->locate  = U('aboutus/vision');
    }
