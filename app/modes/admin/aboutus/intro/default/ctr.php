<?php
class clsAboutusIntroDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        $this->output->locate  = U('aboutus/intro/default/default.html');
