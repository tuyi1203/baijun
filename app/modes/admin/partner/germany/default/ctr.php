<?php
class clsPartnerGermanyDefaultController extends clsAppController implements IAction_default , IAction_update{
    ...
    public function _update() {
        ...
        if (!$model->mw_single->update($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->germany->failupdate;
            return;
        }
        ...
        $this->output->message = $this->lang->germany->successupdate;
        $this->output->locate  = U('partner/germany/default/default.html');
