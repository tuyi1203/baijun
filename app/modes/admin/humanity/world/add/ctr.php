<?php
class clsHumanityWorldAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if (!$this->model->insert($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->world->failinsert;
            return;
        }
        ...
        if(!$this->loadController('admin.system.file.default')
             ->updateObjectID($this->input->uid, $insertid, 'world')) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->world->failinsert;
            return;
        }
        ...
        $this->output->message = $this->lang->world->successinsert;
        $this->output->locate  = U('humanity/world/default/default.html');
