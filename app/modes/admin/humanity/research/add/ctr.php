<?php
class clsHumanityResearchAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if (!$this->model->insert($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->research->failinsert;
            return;
        }
        ...
        if(!$this->loadController('admin.system.file.default')
             ->updateObjectID($this->input->uid, $insertid, 'research')) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->research->failinsert;
            return;
        }
        ...
        $this->output->message = $this->lang->research->successinsert;
        $this->output->locate  = U('humanity/research/default/default.html');
