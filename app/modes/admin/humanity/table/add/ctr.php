<?php
class clsHumanityTableAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if (!$this->model->insert($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->table->failinsert;
            return;
        }
        ...
        if(!$this->loadController('admin.system.file.default')
             ->updateObjectID($this->input->uid, $insertid, 'table')) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->table->failinsert;
            return;
        }
        ...
        $this->output->message = $this->lang->table->successinsert;
