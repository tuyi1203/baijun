<?php
class clsHumanityLifeAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if (!$this->model->insert($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->life->failinsert;
            return;
        }
        ...
        if(!$this->loadController('admin.system.file.default')
             ->updateObjectID($this->input->uid, $insertid, 'life')) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->life->failinsert;
            return;
        }
        ...
        $this->output->message = $this->lang->life->successinsert;
