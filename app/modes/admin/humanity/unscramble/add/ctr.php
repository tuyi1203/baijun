<?php
class clsHumanityUnscrambleAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if (!$this->model->insert($input)) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->unscramble->failinsert;
            return;
        }
        ...
        if(!$this->loadController('admin.system.file.default')
             ->updateObjectID($this->input->uid, $insertid, 'unscramble')) {
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->unscramble->failinsert;
            return;
        }
        ...
        $this->output->message = $this->lang->unscramble->successinsert;
        $this->output->locate  = U('humanity/unscramble/default/default.html');
