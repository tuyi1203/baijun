<?php
class clsHomeTopsetEditController extends clsAppController implements IAction_default , IAction_update{
...
//pr($this->input->fileids);
        ...
        if($ok) {
            ...
            $this->output->message = $this->lang->topset->successupdate;
            $this->output->locate  = 'home_topset-default-default.html';
        } else {
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topset->failupdate;
        }
