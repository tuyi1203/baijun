...
$lang->intro->create       = '添加企业简介';
$lang->intro->modulechoose = '选择一级模块';
$lang->intro->modechoose   = '选择模式';

$lang->intro->successsort     = '排序成功保存';
$lang->intro->failsort        = '排序保存失败';
$lang->intro->successupdate   = '更新企业简介成功';
$lang->intro->failupdate      = '更新企业简介失败';
$lang->intro->successinsert   = '新增企业简介成功';
$lang->intro->failinsert      = '新增企业简介失败';
$lang->intro->successdelete   = '删除企业简介成功';
$lang->intro->faildelete      = '删除企业简介失败';
// $lang->slide->noImageSelected = '没有选择图片';
// $lang->slide->suitableSize    = '同一企业简介中的所有图片尺寸应该保持一致，最佳图片尺寸：1140px X 270px(宽 X 高)';
