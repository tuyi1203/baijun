<?php /* Smarty version Smarty-3.1.6, created on 2015-10-20 15:31:44
         compiled from "D:\xampp\htdocs\baijun\app\modes\admin\news\company\default\index.html" */ ?>
<?php /*%%SmartyHeaderCode:142065625ede065fb18-69785668%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '14cf809029f014a0a1e0c3625d519b6a9e6ab28d' => 
    array (
  ...
  'nocache_hash' => '142065625ede065fb18-69785668',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5625ede08a497',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5625ede08a497')) {function content_5625ede08a497($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['WWW_PATH']->value)."/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
		...
		<div class='col-md-10'>
			<div class='panel'>
				<div class='panel-heading'>
					<strong><i class='icon-list-ul'></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['la']->value['company']['common'];?>
</strong>
					<div class='panel-actions'><a href='{:U('news/company/add/default.html')}' class="btn btn-primary"><i class="icon-plus"></i> <?php echo $_smarty_tpl->tpl_vars['la']->value['company']['create'];?>
</a>
				    </div>
				</div>
				...
				<!-- <form id='sortForm'
				  ...
				  <table class='table table-hover table-striped tablesorter'>
				    <thead>
				      <tr>
		                <th class='text-center w-60px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="id"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="id"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['id'];?>
				        ...
				        <th class='text-center'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="title"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="title"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['title'];?>
				        ...
				        <th class='text-center w-160px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="createby"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="createby"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['author'];?>
				        ...
				        <th class='text-center w-160px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="createtime"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="createtime"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['addedDate'];?>
				        ...
				        <th class='text-center w-60px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="views"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="views"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['views'];?>
				        ...
				        <th class='text-center w-160px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="status"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="status"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
<?php }?>.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['status'];?>
				        ...
				        <th class='text-center w-160px'><div class='<?php if ($_smarty_tpl->tpl_vars['orderby']->value=="public"&&$_smarty_tpl->tpl_vars['sort']->value=="desc"){?>headerSortDown<?php }elseif($_smarty_tpl->tpl_vars['orderby']->value=="public"&&$_smarty_tpl->tpl_vars['sort']->value=="asc"){?>headerSortUp<?php }else{ ?>header<?php }?>'><a href='{:U('news/company/default/sort/currpage/<?php echo $_smarty_tpl->tpl_vars['currpage']->value;?>
...
</small><?php }?><a href="{:U('site/news/company/detail/default/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
...
<?php }?></td>
                        <td class='text-center <?php if ($_smarty_tpl->tpl_vars['kv']->value['public']=="1"){?>is-visible<?php }?>'><?php if ($_smarty_tpl->tpl_vars['kv']->value['public']=="1"){?><?php echo $_smarty_tpl->tpl_vars['la']->value['company']['published'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['la']->value['company']['unpublished'];?>
<?php }?></td>
                        <td class='text-center'>
                        <?php if ($_smarty_tpl->tpl_vars['kv']->value['status']=="1"&&$_smarty_tpl->tpl_vars['publishauth']->value=='1'){?>
                          <a href='{:U('news/company/default/publish/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
...
<?php }?></a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['kv']->value['public']=="1"&&$_smarty_tpl->tpl_vars['kv']->value['status']=="1"&&$_smarty_tpl->tpl_vars['settopauth']->value=='1'&&$_smarty_tpl->tpl_vars['kv']->value['top']!='1'){?>
                          <a href='{:U('news/company/default/settop/objecttype/company/id/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
...
.json')}' class="settoper"><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['unsettop'];?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['kv']->value['public']=="0"){?>
                          <a href='{:U('news/company/edit/default/id/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
.html')}' ><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['editor'];?>
</a>
                        <?php }?>  
			                <a href='{:U('system/topimage/edit/default/objecttype/company/objectid/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
.modal')}' data-toggle='modal'><?php echo $_smarty_tpl->tpl_vars['la']->value['article']['cover'];?>
</a>
			            <?php if ($_smarty_tpl->tpl_vars['kv']->value['public']=="0"){?>    
			                <a href='{:U('news/company/default/delete/id/<?php echo $_smarty_tpl->tpl_vars['kv']->value['id'];?>
