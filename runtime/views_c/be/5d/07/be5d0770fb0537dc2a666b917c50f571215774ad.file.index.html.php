<?php /* Smarty version Smarty-3.1.6, created on 2015-10-10 14:09:41
         compiled from "D:\xampp\htdocs\baijun\app\modes\admin\module\first\edit\index.html" */ ?>
<?php /*%%SmartyHeaderCode:267925618aba575a3a9-61190492%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be5d0770fb0537dc2a666b917c50f571215774ad' => 
    array (
      0 => 'D:\\xampp\\htdocs\\baijun\\app\\modes\\admin\\module\\first\\edit\\index.html',
      1 => 1444457320,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '267925618aba575a3a9-61190492',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5618aba580949',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5618aba580949')) {function content_5618aba580949($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'D:\\xampp\\htdocs\\baijun\\eku\\plugins\\smarty\\plugins\\function.html_options.php';
		...
		<div class='col-md-10'>
			<div class='panel'>
				<div class='panel-heading'>
					<strong><i class='icon-picture'></i><?php echo $_smarty_tpl->tpl_vars['la']->value['first']['edit'];?>
</strong>
				</div>
				...
				<form id='ajaxForm'
                    action='{:U('module/first/edit/update.json')}' method='post'>
					<table class='table table-form'>
					   <tr>
                          <th class='w-100px'><?php echo $_smarty_tpl->tpl_vars['la']->value['first']['mode'];?>
</th>
...
<!--
                          <select name='data[mode]' id='mode' class='form-control chosen'>
                            ...
                            </td><td><input type="hidden" name="data[id]" value="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
">
...
' class="form-control" />
                       ...
                       <tr>
                          ...
                          <td colspan='2'>
                          <div class="required required-wrapper"></div>
                          <input type='text' name='data[des_en]' id='des_en' value='<?php echo $_smarty_tpl->tpl_vars['des_en']->value;?>
' class="form-control" />
                          </td>
                       </tr>
                        <tr>
