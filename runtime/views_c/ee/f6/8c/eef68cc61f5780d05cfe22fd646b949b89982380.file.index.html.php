...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '104435618ab0cc09de2-99827614',
  'function' => 
  array (
  ),
		...
		<div class='col-md-10'>
			<div class='panel'>
				<div class='panel-heading'>
					<strong><i class='icon-picture'></i><?php echo $_smarty_tpl->tpl_vars['la']->value['first']['add'];?>
</strong>
				</div>
				...
				<form id='ajaxForm'
                    action='{:U('module/first/add/insert.json')}' method='post'>
