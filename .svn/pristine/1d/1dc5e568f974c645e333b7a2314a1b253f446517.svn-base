...
class captcha
{
    ...
    function captcha($folder = '')
    {
        ...
        {
            $this->folder = dirname(__FILE__) . DS . 'imgs' . DS ;
        }
     ...
     * @return void
     */
    function __construct($folder = '', $width = null, $height = null)
    {
...
// pr($theme);
        ...
        else
        {
            ...
            /* 获得验证码的高度和宽度 */
            $x = ($this->width - (imagefontwidth(10) * $letters)) / 2;
            $y = ($this->height - imagefontheight(10)) / 2;
            imagestring($img_org, 10, $x, $y, $word, $clr);
