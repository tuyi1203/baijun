<?php
class clsHomeTopsetAddController extends clsAppController implements IAction_default , IAction_insert{
    ...
    public function _insert() {
        ...
        if($ok) {
            ...
            $this->output->message = $this->lang->topset->successinsert;
            $this->output->locate  = 'home_topset-default-default.html';
        } else {
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topset->failinsert;
        }
