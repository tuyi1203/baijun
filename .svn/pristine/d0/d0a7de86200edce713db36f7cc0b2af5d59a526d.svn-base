<?php
class clsHomeTopdesignerDefaultController extends clsAppController
...
// pr($this->input->sort);
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->topdesigner->successsort;
        }
        else {
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topdesigner->failsort;
        }
    ...
    public function _delete() {
       ...
       if(!$model->mw_top->delete($this->input)) {
        ...
        if($ok) {
            ...
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topdesigner->faildelete;
        }
