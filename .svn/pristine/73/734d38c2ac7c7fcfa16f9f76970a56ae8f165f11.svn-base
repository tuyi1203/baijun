<?php
class clsHomeTopsetDefaultController extends clsAppController
...
// pr($this->input->sort);
        ...
        if ($ok) {
            ...
            $this->output->message = $this->lang->topset->successsort;
        }
        else {
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topset->failsort;
        }
    ...
    public function _delete() {
       ...
       if(!$model->mw_top->delete($this->input)) {
        ...
        if($ok) {
            ...
            $this->mdb->subRollBack();
            $this->output->result  = 'fail';
            $this->output->message = $this->lang->topset->faildelete;
        }
